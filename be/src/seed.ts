import { db } from "./db";
import { locations, restaurants, restaurantImages } from "./db/schema";
        ...
        const [kualaLumpur, penang, johorBahru] = await db.insert(locations).values([
            {
                name: "Kuala Lumpur",
                slug: "kuala-lumpur",
                seoTitle: "Best Restaurants in Kuala Lumpur - Teeko Advisor",
            ...
            },
            {
                name: "Penang",
                slug: "penang",
                seoTitle: "Best Restaurants in Penang - Teeko Advisor",
            ...
            },
            {
                name: "Johor Bahru",
                slug: "johor-bahru",
                seoTitle: "Best Restaurants in Johor Bahru - Teeko Advisor",
