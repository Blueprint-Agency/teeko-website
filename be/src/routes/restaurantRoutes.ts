...
import { getRestaurants, createRestaurant, getRestaurantBySlug, updateRestaurant, getRestaurantById, createRestaurantByTripAdvisorID, getRestaurantByTripAdvisorID, getRestaurantStatsByGoogleSearchQuery, getRestaurantShortVideosBySearchQuery, updateRestaurantStatus, searchRestaurantOptions } from "../controllers/restaurantController";
import { requireAdmin } from "../middleware/authMiddleware";

const router = Router();

router.get("/", getRestaurants);
router.get("/options/search", searchRestaurantOptions);
